...
<div class="page-content clearfix">
 ...
 <div class="clearfix">
  <div class="home_btn">
     <div>
     <a href="/admin/picture-add.html" title="添加商品" class="btn  btn-info btn-sm no-radius">
     <i class="bigger-200"><img src="/admin/images/icon-addp.png" /></i>
     <h5 class="margin-top">添加商品</h5>
     </a>
     <a href="/admin/Category_Manage.html" title="产品分类" class="btn  btn-primary btn-sm no-radius">
     <i class="bigger-200"><img src="/admin/images/icon-cpgl.png" /></i>
     <h5 class="margin-top">产品分类</h5>
     </a>
     <a href="/admin/admin_info.html" title="个人信息" class="btn  btn-success btn-sm no-radius">
     <i class="bigger-200"><img src="/admin/images/icon-grxx.png" /></i>
     <h5 class="margin-top">个人信息</h5>
     </a>
     <a href="/admin/Systems.html" title="系统设置" class="btn  btn-info btn-sm no-radius">
     <i class="bigger-200"><img src="/admin/images/xtsz.png" /></i>
     <h5 class="margin-top">系统设置</h5>
     </a>
     <a href="/admin/Order_handling.html" title="商品订单" class="btn  btn-purple btn-sm no-radius">
     <i class="bigger-200"><img src="/admin/images/icon-gwcc.png" /></i>
     <h5 class="margin-top">商品订单</h5>
     </a>
     <a href="/admin/picture-add.html" title="添加广告" class="btn  btn-pink btn-sm no-radius">
     <i class="bigger-200"><img src="/admin/images/icon-ad.png" /></i>
     <h5 class="margin-top">添加广告</h5>
     </a>
      <a href="/admin/article_add.html" title="添加文章" class="btn  btn-info btn-sm no-radius">
